    ...
    <div className="min-h-screen flex items-start justify-center py-10 px-4 bg-background text-foreground">
      <div className="w-full max-w-lg space-y-8">
        ...
        <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 justify-center">
          ...
          <div className="w-full sm:w-[calc(25%-12px)]">
            <Button variant="icon" square icon={GitlabIcon}>
              GitLab
            </Button>
          </div>

          <div className="w-full sm:w-[calc(25%-12px)]">
            <Button variant="icon" square icon={BitbucketIcon}>
              Bitbucket
            </Button>
          </div>

          <div className="w-full sm:w-[calc(25%-12px)]">
            <Button variant="icon" square icon={GoogleIcon}>
              Google
            </Button>
          </div>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input className="form-input mt-2" type="password" placeholder="correct horse battery staple" />
          </div>

          <p className="text-xs text-muted-foreground -mt-4">
            By signing up you agree to our{" "}
            <a className="text-primary-accent hover:underline">terms of service</a>{" "}
            and{" "}
            <a className="text-primary-accent hover:underline">privacy policy</a>.
          </p>
          ...
          <p className="text-sm text-left text-muted-foreground mt-3">
          ...
          <p className="text-xs text-left text-muted-foreground mt-4">
            This site is protected by hCaptcha. Its{" "}
            <a className="hover:underline">Privacy Policy</a> &{" "}
            <a className="hover:underline">Terms of Service</a> apply.
          </p>
